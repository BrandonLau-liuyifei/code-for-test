...
# testsuite过程
#创建一个测试加载器
from unittest_learning.unittest_learning_01.HTMLTestRunner import HTMLTestRunner

loader = unittest.TestLoader()
# 创建测试套件
suite = unittest.TestSuite()
#从测试类中加载测试用例
tests = loader.loadTestsFromTestCase(unittest_learning_01.unittest_learning.case_01.userTestCase)
#将测试用例加载到测试组
