...
sleep(2)
browser.find_element(By.CSS_SELECTOR,"div.ui-accordion-content:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(9) > td:nth-child(1) > a:nth-child(1)").click()
sleep(2)
